...
## [v0.5.0](https://github.com/livebook-dev/kino_db/tree/v0.5.0) (2026-06-29)

### Changed

* Use ADBC instead of Explorer for Clickhouse ([#87](https://github.com/livebook-dev/kino_db/pull/87))

## [v0.4.0](https://github.com/livebook-dev/kino_db/tree/v0.4.0) (2025-10-24)

### Changed

* Use `Adbc.Result` instead of `Explorer` when possible
