...
export function init(ctx, info) {
      ...
      <div class="input-icon-container grow">
        ...
        <div class="icon-container">
          <label class="hidden-checkbox">
            ...
            />
            <svg v-if="fields.use_password_secret" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 width="22" height="22">
  ...
  const AthenaForm = {
    ...
    methods: {
      ...
      selectSecret() {
        const preselectName = this.fields.secret_access_key_secret;
        ctx.selectSecret((secretName) => {
          ctx.pushEvent("update_field", {
    ...
    <div class="row mixed-row">
      ...
      <div class="input-icon-container grow">
        <BaseInput
          v-if="fields.use_secret_access_key_secret"
          name="secret_access_key_secret"
          label="Secret Access Key"
          v-model="fields.secret_access_key_secret"
          inputClass="input input-icon"
          :grow
          readonly
          @click="selectSecret"
        ...
        <div class="icon-container">
          <label class="hidden-checkbox">
            <input
              type="checkbox"
              :value="fields.use_secret_access_key_secret"
              name="use_secret_access_key_secret"
              v-model="fields.use_secret_access_key_secret"
              class="hidden-checkbox-input"
            />
            <svg v-if="fields.use_secret_access_key_secret" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 width="22" height="22">
              <path fill="none" d="M0 0h24v24H0z"/>
              <path d="M18 8h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1h2V7a6 6 0 1 1 12 0v1zM5
                10v10h14V10H5zm6 4h2v2h-2v-2zm-4 0h2v2H7v-2zm8 0h2v2h-2v-2zm1-6V7a4 4 0 1 0-8 0v1h8z" fill="#000"/>
