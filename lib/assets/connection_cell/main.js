...
export function init(ctx, info) {
  ...
  const BaseSecret = {
    ...
    methods: {
      selectSecret() {
        const preselectName = this.secretValue;
        ctx.selectSecret(
          (secretName) => {
    ...
    template: `
      <div class="input-icon-container grow">
        <BaseInput
          ...
          readonly
          @click="selectSecret"
          @input="$emit('update:secretValue', $event.target.value)"
        />
        <BaseInput
          v-else
          :name="inputName"
        ...
        <div class="icon-container">
          <label class="hidden-checkbox">
            ...
            />
            <svg v-if="toggleValue" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  width="22" height="22">
  ...
  const DefaultSQLForm = {
    ...
    <div class="row">
      ...
      <BaseSecret
        ...
        toggleName="use_password_secret"
        inputLabel="Password"
        secretLabel="Password"
        v-model:inputValue="fields.password"
        v-model:secretValue="fields.password_secret"
        v-model:toggleValue="fields.use_password_secret"
  ...
  const AthenaForm = {
    ...
    <div class="row mixed-row">
      ...
      />
      <BaseSecret
        inputName="secret_access_key"
        secretName="secret_access_key_secret"
        toggleName="use_secret_access_key_secret"
        inputLabel="Secret Access Key"
        secretLabel="Secret Access Key"
        v-model:inputValue="fields.secret_access_key"
        v-model:secretValue="fields.secret_access_key_secret"
        v-model:toggleValue="fields.use_secret_access_key_secret"
