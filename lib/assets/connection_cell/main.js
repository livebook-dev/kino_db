...
export function init(ctx, info) {
  ...
  const DefaultSQLForm = {
    ...
    methods: {
      ...
      requestSecret() {
        const currentSecret = this.fields.password_secret;
        ctx.requestSecret(currentSecret, (secretLabel) => {
          ctx.pushEvent("update_field", { field: "password_secret", value: secretLabel });
        });
      },
    },
    ...
    <div class="row">
      ...
      <div class="input-icon-container grow" v-if="fields.use_password_secret">
        <BaseInput
          ...
          readonly
        />
        <div class="icon-container" @click="requestSecret">
