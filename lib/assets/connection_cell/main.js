  ...
  const DefaultSQLForm = {
    ...
    <div class="row">
      <BaseInput
        ...
        :grow
      />
      <div class="icon-input-container grow" v-if="fields.password_secret">
        <BaseSelect
          name="password_from_secret"
          label="Password"
          v-model="fields.password_from_secret"
          :options="availableSecrets"
          selectClass="input icon-input"
          :grow
        />
      ...
      <label class="hidden-checkbox">
        ...
        />
        <span v-if="fields.password_secret" class="button--sm">
