    ...
    <div class="row">
      ...
      <template v-if="locked">
        <BaseSelect
          ...
          :grow
        />
        <button class="button button--sm" type="button" @click="toggleLock()">
        <svg class="button-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
          <path fill="none" d="M0 0h24v24H0z"/>
          <path d="M7 10h13a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V11a1 1 0 0 1 1-1h1V9a7 7 0 0 1
          13.262-3.131l-1.789.894A5 5 0 0 0 7 9v1zm-2 2v8h14v-8H5zm5 3h4v2h-4v-2z"
          fill="#000"/>
        </svg>
        </button>
      </template>
      <template v-else>
        ...
        <svg class="button-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
          ...
          10v10h14V10H5zm6 4h2v2h-2v-2zm-4 0h2v2H7v-2zm8 0h2v2h-2v-2zm1-6V7a4 4 0 1 0-8 0v1h8z"
          fill="#000"/>
        </svg>
        </button>
      </template>
